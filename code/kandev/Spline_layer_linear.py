...
# =====================================================
# === Helper functions for spline basis computation ===
# =====================================================

def B_batch(x, grid, k=3, extend=True, device='cpu'):
    '''
...
class KAN_Spline_linear_w_base(nn.Module):
    ...
    -----------
        ...
        device: str
            device
    """
    def __init__(self, in_dim=3, out_dim=2, num_grid=5, 
                 num_mult=0, mult_arity=2, num_exp=0, addbias=True,
                 k=3,noise_scale=0.5, scale_base_mu=0.0, 
                 scale_base_sigma=1.0, scale_sp=1.0, 
                 base_fun=torch.nn.SiLU(), grid_eps=0.02, 
        ...
        self.num = num_grid
        self.k = k
        # print("inside KANLayer setting  k=", self.k)
